...
class TricepsExercise extends StatefulWidget {
  @override
  _AbsExerciseState createState() => _AbsExerciseState();
}

class _AbsExerciseState extends State<TricepsExercise> {
  late VideoPlayerController _controller;

  @override
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset("assets/T1.mp4")
      ..initialize().then((_) {
